var myScript = new ( function($) {
	...
	this.DrawMainChart = function(graphData, divID, datatype_id, period, details, indicator_id) {
		...
		$(".amcharts-guide-g1 tspan").attr("x",function(index,currentvalue){ return currentvalue = 280; });
		$(".amcharts-guide-g1 tspan").attr("y",function(index,currentvalue){ return currentvalue = -1; });
		$(".amcharts-guide-g2 tspan").attr("x",function(index,currentvalue){ return currentvalue = 280; });
		$(".amcharts-guide-g2 tspan").attr("y",function(index,currentvalue){ return currentvalue = 19; });		
		$(".amcharts-guide-g3 tspan").attr("x",function(index,currentvalue){ return currentvalue = 280; });
		$(".amcharts-guide-g3 tspan").attr("y",function(index,currentvalue){ return currentvalue = 9; });		
	}
